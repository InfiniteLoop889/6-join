            ...
            <div class="modal-right">
                ...
                <form class="contact-container">
                    ...
                    <div class="contact-form">
                        ...
                        <div class="input-container" onclick="checkForError(event)">
                            <input type="tel" class="signup-input" id="contact-phone" value="${user.phone}" placeholder="Phone" name="phone" data-field="phone">
                            <img src="../assets/icons/call.svg" alt="envelope-icon" class="signup-icon">
                        </div>
                        <p class="error-signup" data-field="errorPhone"></p>
                        <div class="buttons">
                            <button type="button" class="cancel" onclick="deleteUser('users/${id}'); closeEditMenu(); hideContacts()">Delete</button>
            ...
            <div class="modal-right">
                ...
                <form class="contact-container" novalidate>
                    ...
                    <div class="contact-form">
                        ...
                        <p class="error-signup" data-field="errorEmail"></p>
                        <div class="input-container" onclick="checkForError(event)">
                            <input type="tel" class="signup-input" id="contact-phone" placeholder="Phone" name="phone" data-field="phone">
                            <img src="../assets/icons/call.svg" alt="envelope-icon" class="signup-icon">
                        </div>
                        <p class="error-signup" data-field="errorPhone"></p>
                        <div class="buttons">
